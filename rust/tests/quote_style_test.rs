...
fn test_enforce_key_style_to_double() {
  ...
  document
    .enforce_key_style(&yerba::QuoteStyle::DoubleQuoted, None)
    .unwrap();
...
fn test_enforce_key_style_to_single() {
  ...
  document
    .enforce_key_style(&yerba::QuoteStyle::SingleQuoted, None)
    .unwrap();
...
fn test_enforce_key_style_scoped_to_path() {
  ...
  document
    .enforce_key_style(&yerba::QuoteStyle::DoubleQuoted, Some("database"))
    .unwrap();
...
fn test_enforce_quotes_scoped_to_single_key() {
  ...
  document
    .enforce_quotes_at(&yerba::QuoteStyle::SingleQuoted, Some("host"))
    .unwrap();
...
fn test_enforce_quotes_scoped_to_nested_key() {
  ...
  document
    .enforce_quotes_at(&yerba::QuoteStyle::DoubleQuoted, Some("database"))
    .unwrap();
